...
class Polygon extends Component {
  ...
  animate(startX, endX, startY, endY, startTime, duration) {
    ...
    let easeX = Easing.easeOutSine.apply(this, [1, currentTime, 0, Math.abs(startX - endX), duration]);
    let easeY = Easing.easeOutSine.apply(this, [1, currentTime, 0, Math.abs(startY - endY), duration]);
    let x;
    let y;
